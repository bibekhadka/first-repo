...
{	
	...
	main_loopid = setInterval(gameLoop,30); //-->gameloop is just a function
}

function gameLoop()
{	
	createEnemy();	//why create and update seperately??  
	reloadBullets(); //updateBullet and updateBullets looked confusing to me
	checkForCollision();
...
function Background()
{		/* I didnot understand the use of "that." in this function so I tweaked the code, hope I didn't break it*/
		background_y = 0;
		background_dy = 7;
		this.updateBackground = function(){
			parent.style.backgroundPosition = "0px "+background_y+"px";
			background_y=background_y+ background_dy;
		}
}
